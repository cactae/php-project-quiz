...
<?php
	...
	*/
	...
	$query = "SELECT * FROM questions
		  WHERE Number = $number AND Quiz_idQuiz = 3";
	...
	*/
	...
	$query = "SELECT * FROM choises
		  WHERE Questions_Number = $number AND Q_id = 3";
	...
	<body>
		...
		<main>
			<div class="current">Question <?php echo $question['Qnumber']; ?> of 10</div>
				...
				<form method="post" action="quiz_tarkistus_three-v1.php">
					<ul class="">
